...
const keyName = "SendProducts";


@inject('store')
@observer
class fahuoPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            refreshing: false,
    ...
    componentDidMount = () => {
        let that = this;
        this.reloadListener = DeviceEventEmitter.addListener("FaHuoEvent", () => {
                ...
                <View style={commonStyle.formRowItem_row_left}>
                    ...
                    <View style={styles.righttext}>
                        <View style={commonStyle.tag_wrap_list}>
                            {item.customAttributes.Area.value != '' ? <View style={commonStyle.tag_wrap_red}><Text style={commonStyle.tag_red_txt}>{item.customAttributes.Area.value}</Text></View> : null}
                            {item.customAttributes.Company.value != '' ? <View style={commonStyle.tag_wrap_red}><Text style={commonStyle.tag_red_txt}>{item.customAttributes.Company.value}</Text></View> : null}
                        </View>
